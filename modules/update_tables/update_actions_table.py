...
def check_new_and_update_actions_with_param(start_day, end_day, filter):
    """
...
def check_new_and_update_actions(start_day, end_day):
    ...
    # Actions qui nous interesse : proposition sur profil(candidat, 43) / proposition sur mission(candidat, 130) / prospection(contacts, 61) / soutenance(contacts, 10)
    check_new_and_update_actions_with_param(start_day, end_day, 43)
    check_new_and_update_actions_with_param(start_day, end_day, 130)
    check_new_and_update_actions_with_param(start_day, end_day, 61)
    check_new_and_update_actions_with_param(start_day, end_day, 10)
